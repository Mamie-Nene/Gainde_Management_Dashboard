...
import '../../domain/remote/statistics/TotalDataForStatistics.dart';

import '/src/utils/const/app_specifications/app_texts.dart';
import '/src/utils/variable/global_variable.dart';


class GetStatisticDataApi{

  Future getTotalDataForStatistic(String URL,String date1, String date2)async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString("token");

    TotalDataForStatistics? dossier  ;
    try{
      ...
      if (response.statusCode == 200) {
        ...
        dossier = TotalDataForStatistics.fromJson(data);
        return dossier;
