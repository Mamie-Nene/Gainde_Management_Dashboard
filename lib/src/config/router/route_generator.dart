...
import 'package:gainde_management_dashboard/src/presentation/pages/orbus/pole/acces_par_pole.dart';
import 'package:gainde_management_dashboard/src/presentation/pages/orbus/my_orbus/my_orbus_home_page.dart';
import 'package:gainde_management_dashboard/src/presentation/pages/orbus/performance_orbus_page.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings)
  {
    ...
    switch (settings.name){
      ...
      case AppRoutesName.orbusInfinityParts :
        return MaterialPageRoute( builder: (context) =>  const OrbusInfinityHomePage());

      case AppRoutesName.performanceOrbus :
       return MaterialPageRoute( builder: (context) => const PerformanceOrbusScreen());
