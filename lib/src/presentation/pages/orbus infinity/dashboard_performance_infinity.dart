...
class DashboardInfinityPage extends StatefulWidget {
  const DashboardInfinityPage({super.key});

  @override
  State<DashboardInfinityPage> createState() => _DashboardInfinityPageState();
}
class _DashboardInfinityPageState extends State<DashboardInfinityPage> {
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    List<String> icons=['material-symbols_anchor','mdi_package-variant','mdi_truck','fluent-emoji-high-contrast_office-building','gis_earth-network','mdi_shield-account'];
